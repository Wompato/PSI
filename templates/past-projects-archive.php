...
<div class="archive-navigation">
    ...
    <ul class="agency-list">
        <?php foreach ($ordered_agencies as $agency) : ?>
            ...
            $agency_link = esc_url(add_query_arg('agency_id', $agency->term_id));
            ?>
...
<?php if (!empty($programs)) : ?>
    <div class="archive-past-projects">
        <h4><?php echo ($selected_program_id) ? 'Projects from ' . get_term($selected_program_id, 'funding-program')->name : 'Past Projects'; ?></h4>
        <div class="section-headline"></div>

        <?php
        // Query for past projects associated with the selected program
        $args = array(
            'post_type' => 'project',
            ...
            // Custom meta query to check for past projects based on end_date
            'meta_query' => array(
                array(
                    'key' => 'end_date',
        ...
        <?php else : ?>
            <p>Sorry, no Past Projects found.</p>
        <?php endif; ?>
